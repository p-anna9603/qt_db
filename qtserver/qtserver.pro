...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../libek/ -lmysqlclient
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../libek/ -lmysqlclientd
else:unix: LIBS += -L$$PWD/../libek/ -lmysqlclient
...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/'../../../../Program Files/MySQL/MySQL Server8.0/lib/' -lmysqlclient
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/'../../../../Program Files/MySQL/MySQL Server8.0/lib/' -lmysqlclientd
else:unix: LIBS += -L$$PWD/'../../../../Program Files/MySQL/MySQL Server8.0/lib/' -lmysqlclient
